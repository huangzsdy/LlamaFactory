...
本项目提供了数据预处理脚本，位于 [`scripts/data_processing/`](scripts/data_processing/) 目录下，可用于处理自定义格式的数据：

| 脚本 | 功能 |
|------|------|
| [`convert_qa_data.py`](scripts/data_processing/convert_qa_data.py) | 处理 QA 数据（`synthesized_QA` 字段） |
